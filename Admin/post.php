...
$postingan = query("SELECT * FROM beritaadmin");
$temppost = query("SELECT * FROM temppost");
$kategori = query("SELECT * FROM kategori");
$postTayang = query("SELECT * FROM postingan");
// var_dump($kategori[3]['namakategori']);
        ...
        <div class="garistepi">
            <table rules="rows" class="tablesetting">
                <tr>
                    ...
                    <th class="col2">Tanggal Penulisan</th>
                    <th class="col2">Penulis</th>
                    <th class="col2">Kategori</th>
                    <th class="col2" colspan="3">Action</th>
                </tr>
                <?php $ii = 0; ?>
...
/*                            if ($a == "") {
                                    echo "<a href='setKategori.php?id=$b'>Set</a>";
                             } else {*/
                                $found = False;
                                $i = 0;
                                while ($i < count($kategori)) {
                                    if ($kategori[$i]['id'] == $a) {
                                        echo $kategori[$i]['namakategori'];
                                        $found = True;
                                    }  
                                    $i += 1;
                                    
                                }
                                if ($i == count($kategori) and !$found) {
                                    $a = $row["info_kategori"];
                                    $b = $row['id'];
                                    echo "<a href='setKategori.php?id=$b'>Set</a>";
                                }
                   ...
                   //echo "<a href='setKategori.php?id=$b'>Set</a>"
                    ?></td> -->
                   <td><a href="setKategori.php?id=<?= $row["id"] ?>">View</a></td>
                   <td><a href="upload.php?id=<?= $row["id"] ?>">Upload</a></td>
        ...
        <div class="garistepi">
            <table rules="rows" class="tablesetting">
                ...
                <tr>
                   ...
                   <td><a href="setkategori2.php?id=<?= $row["id"] ?>">View</a></td>
                   <!-- <td><a href="upload.php?id=<?= $row["id"] ?>">Upload</a></td> -->
                   <td><a href="delPost.php?id=<?= $row["id"] ?>" onclick="return confirm('yakin?')"><img src="img/logoTrash.png" width="20"></a></td>
               </tr>
               <?php $ii++; ?>
