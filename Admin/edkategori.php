        ...
        <div>
			<table class="tablesetting">
               ...
               <tr>
                   ...
                   <td><?=$row["deskripsi"]  ?></td>
                   <td><a href="editKategori.php?id=<?= $row["id"] ?>"><img src="img/logoEdit.png" width="20"></a></td>
                   <td><a href="delKategori.php?id=<?= $row["id"] ?>" onclick="return confirm('yakin?')"><img src="img/logoTrash.png" width="20"></a></td>
               </tr>
               <?php $i++; ?>
               <?php endforeach; ?>
