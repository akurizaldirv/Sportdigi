...
$post = query("SELECT * FROM beritaadmin WHERE id = '$id'")[0];
...
<body>
    ...
    <div>
        ...
        <div class="pengisi"><?=$post['info_kategori']?></div>
    ...
    <div class="form-group">
        <label for="Set">Set Kategori:</label><br>
        <form id="pilih" method="POST" action="">
            <input type="hidden" name="id" value="<?= $post["id"]; ?>">
            <select id='ktrg' name="ktrg" class="form-control" style="width: 98%; margin-top: 5px;">
