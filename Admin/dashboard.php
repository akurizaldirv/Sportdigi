...
$jumlah_postingan = hitung_baris("beritaadmin");
$jumlah_kategori = hitung_baris("kategori");
$jumlah_komentar = hitung_baris("komentar");
$jumlah_tayang = hitung_baris("postingan");
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="card-box widget-box-one">
                    ...
                    <div class="wigdet-one-content">
                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Listed Incoming News</p>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="card-box widget-box-one">
                    <i class="mdi mdi-layers widget-one-icon"></i>
                    <div class="wigdet-one-content">
                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Listed Uploaded News</p>
                        <h2><?php echo $jumlah_tayang ?><small></small></h2>
                    </div>
                </div>
            </div>
            </a>
