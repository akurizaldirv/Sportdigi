    ...
    <div class="badan-utama">
        ...
        <form action="" method="post" >
            <ul class="khususul">
                ...
                <li class="admin"><a href="login/"><img src="img/user.png" width="25px"></a></li>
...
<div class="content">
      <div class="left" id="left">
        ...
        ?>
        <?php foreach ($showpop as $row) : ?>
        <li><a href="tampilpost.php?id=<?= $row['id'] ?>" class="active"><?= $row['judul'] ?></a></li>
        <?php endforeach; ?>
        </ul>
      </div>
            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    ...
                    <?php 
                     ...
                     ?>
                    <p><b>Category : </b> <a href="tampilkategori.php?id=<?=$idKategori?>"><?= $namakategori  ?></a> </p>
                    <p>
                         <?php 
                            $a = $row['isi'];
                            // echo $a;
