...
$berita = query("SELECT * FROM beritapenulis");
...
if (isset($_POST["submit"]) ){
    ...
    if (tulisBerita($_POST)>0){
        echo "
        <script>
        alert ('Berhasil menulis berita, silahkan ajukan berita anda');
...
<body>
    <h1 class="text-primary">Tulis Berita</h1>
    <hr>
